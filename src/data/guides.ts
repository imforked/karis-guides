...
export const GUIDES: readonly Guide[] = [
  ...
  {
    id: "mushrooms-of-the-northwest",
    title: "Mushrooms of the Northwest",
    summary: "Regional mushroom identification and foraging reference.",
    fileName: "mushrooms-of-the-northwest.pdf",
    tags: ["foraging", "wilderness", "food", "medical"],
  },
  {
    id: "peterson-field-guides-mushrooms",
    title: "Peterson Field Guides: Mushrooms",
    summary: "Classic field guide to mushroom identification.",
    fileName: "peterson-field-guides-mushrooms.pdf",
    tags: ["foraging", "wilderness", "food", "medical"],
  },
  {
    id: "northwest-native-plants",
    title: "Northwest Native Plants",
    summary: "Native plant identification and uses in the Pacific Northwest.",
    fileName: "northwest-native-plants.pdf",
    tags: ["foraging", "wilderness", "food", "medical"],
  },
  {
    id: "boy-scout-handbook",
    title: "Boy Scout Handbook",
    summary: "Scouting outdoor skills, first aid, camping, and citizenship reference.",
    fileName: "boy-scout-handbook.pdf",
    tags: [
      "water",
      "fire",
      "shelter",
